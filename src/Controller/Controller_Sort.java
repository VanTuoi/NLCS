...
public class Controller_Sort implements Runnable{
	...
	private int MAX_BAR_HEIGHT = 0, MIN_BAR_HEIGHT = 30;
...
//            	System.out.println("run_1");
	...
	public Controller_Sort(int capacity, int fps,MainFrame mainFrame){
...
//	}
	...
	public void finishAnimation()
	{
		...
		mainFrame.Set_Info(comparison,swap);
	...
	private void colorBar(int index, Color color)
	{
		...
		mainFrame.Set_Info(comparison,swap);			// set value
	...
	public interface SortedListener
	{
		...
		void Set_Info(int comparison,int swap);
	}
}